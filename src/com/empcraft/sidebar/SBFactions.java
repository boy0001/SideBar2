...
public class SBFactions  implements Listener {
	SideBar plugin;
    public SBFactions(SideBar SB,Plugin factions) {
    	SB.addPlaceholder(new Placeholder("faction",factions) {
	        @Override
        ...
        SB.addPlaceholder(new Placeholder("fpower",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
	        	UPlayer uplayer = UPlayer.get(player);
        ...
        SB.addPlaceholder(new Placeholder("fmaxpower",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
	        	UPlayer uplayer = UPlayer.get(player);
        ...
        SB.addPlaceholder(new Placeholder("fpowerboost",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
	        	UPlayer uplayer = UPlayer.get(player);
        ...
        SB.addPlaceholder(new Placeholder("fusers",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
        ...
        SB.addPlaceholder(new Placeholder("fuserlist",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
	        	if (modifiers.length>0) {
	        		Faction faction = FactionColls.get().getForWorld(player.getWorld().getName()).getByName(modifiers[0]);
        ...
        SB.addPlaceholder(new Placeholder("flist",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
        ...
        SB.addPlaceholder(new Placeholder("factions",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
        ...
        SB.addPlaceholder(new Placeholder("fdesc",factions) {
	        @Override
	        public String getValue(Player player, Location location,String[] modifiers, Boolean elevation) {
	        	if (modifiers.length>0) {
	        		Faction faction = FactionColls.get().getForWorld(player.getWorld().getName()).getByName(modifiers[0]);
